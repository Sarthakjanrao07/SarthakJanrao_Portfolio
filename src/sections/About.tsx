...
export const About: React.FC = () => {
    ...
    return (
        <SectionWrapper id="about">
            ...
            <div style={{ maxWidth: '900px', margin: '40px auto 0', textAlign: 'center', color: 'rgba(255,255,255,0.7)', fontSize: 'clamp(0.95rem, 3.5vw, 1.1rem)', lineHeight: 1.8, position: 'relative' }}>
                <p>
