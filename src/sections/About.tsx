...
export const About: React.FC = () => {
    ...
    return (
        <SectionWrapper id="about">
            ...
            <div className="about-bio-text" style={{ maxWidth: '800px', margin: '40px auto 0', textAlign: 'center', color: 'rgba(255,255,255,0.7)', fontSize: '1.1rem', lineHeight: 1.8, position: 'relative' }}>
                <p>
